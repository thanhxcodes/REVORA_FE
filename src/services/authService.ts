...
// ==========================================
// 1. TypeScript Interfaces (Matching Backend)
// ==========================================
...
export interface AuthResponse {
  accessToken: string;
  expiresAt: string; // ISO DateTime string đại diện cho thời gian hết hạn của Access Token
}

// ==========================================
// 2. In-Memory Token Storage & Helper Functions
// ==========================================
